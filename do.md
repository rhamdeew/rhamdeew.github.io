...
1) Первым делом мы регистрируем VPS на DigitalOcean. Выбираем образ Ubuntu 14.04.3 и регион ближайший к вам и вашим клиентам.
...
Задаем пароль пользователю static
	...
	passwd static
*password don't match root pass!*
...
На сервере от пользователя static:
